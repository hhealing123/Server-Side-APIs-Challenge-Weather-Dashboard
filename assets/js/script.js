...
// Function that will display the current conditions
var getCurrentConditions = (event) => {
    // Search city name from the search box
...
// Function that will obtain the five day forecast and display to HTML
